    ...
    <div class="container">
        <div class="footer-grid">
            <div class="footer-col">
                <h4><?php echo htmlspecialchars($settings['footer']['col1_title'] ?? 'LEXODUS Kft.'); ?></h4>
                <p style="font-size: 0.9rem; line-height: 1.6; margin-bottom: 20px;">
                    <?php echo nl2br(htmlspecialchars($settings['footer']['col1_text'] ?? 'Társaságunk az IFS magyarországi képviselete...')); ?>
                </p>
            ...
            <div class="footer-col">
                <h4><?php echo htmlspecialchars($settings['footer']['col2_title'] ?? 'Navigáció'); ?></h4>
                <ul>
            ...
            <div class="footer-col">
                <h4><?php echo htmlspecialchars($settings['footer']['col3_title'] ?? 'Kapcsolat'); ?></h4>
