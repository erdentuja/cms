...
if ($slug === 'index' || $slug === ''): ?>
    <section class="hero">
        <div class="container">
            <h1 style="color: #fff; font-size: 3rem; margin-bottom: 20px;">Üdvözöljük a LEXODUS Kft. megújult oldalán</h1>
            <p style="color: rgba(255,255,255,0.9); font-size: 1.2rem; max-width: 800px; margin: 0 auto 30px auto;">
                Az IFS magyarországi képviselete – Tapasztalat, szakértelem és modern megoldások az élelmiszerbiztonság és
                minőségirányítás területén.
            </p>
            <div style="display: flex; gap: 15px; justify-content: center;">
                <a href="#services" class="btn-modern">Szolgáltatásaink</a>
                <a href="/kapcsolat" class="btn-modern"
                    style="background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.3); backdrop-filter: blur(5px);">Kapcsolat</a>
            </div>
        </div>
    </section>
<?php endif; ?>
...
<div class="container" style="padding-top: 40px;">
    <?php if ($slug !== 'index' && $slug !== ''): ?>
        <h1 style="border-bottom: 3px solid #003366; padding-bottom: 10px; display: inline-block;">
            <?php echo htmlspecialchars($page['title']); ?></h1>
    <?php endif; ?>
